...
SITEMAP_URL = "https://www.news18.com/commonfeeds/v1/eng/sitemap/google-news/today.xml"
...
def fetch_sitemap(limit: int = 10) -> list[dict]:
    ...
    # lxml can't handle the stray <script> tags News18 injects — strip them first
